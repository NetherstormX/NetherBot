...
local adminFrame = CreateFrame("Frame", "MyAddonAdminFrame", UIParent)
...
-- Create the buttons
-- Follow Button
local followButton = CreateFrame("Button", "MyAddonFollowButton", frame, "ActionButtonTemplate")
...
-- StandStill Button
local standstillButton = CreateFrame("Button", "MyAddonStandstillButton", frame, "ActionButtonTemplate")
...
--FullStop Button
local fullstopButton = CreateFrame("Button", "MyAddonfullstopButton", frame, "ActionButtonTemplate")
...
--Distance1 Button
local distance1Button = CreateFrame("Button", "MyAddondistance1Button", frame, "ActionButtonTemplate")
...
--Distance2 Button
local distance2Button = CreateFrame("Button", "MyAddondistance2Button", frame, "ActionButtonTemplate")
...
--Distance3 Button
local distance3Button = CreateFrame("Button", "MyAddondistance3Button", frame, "ActionButtonTemplate")
...
local adminButton = CreateFrame("Button", "MyAddonAdminButton", frame, "UIPanelButtonTemplate")
...
local buttonAdd = CreateFrame("Button", "MyAddonButtonAdd", adminFrame, "UIPanelButtonTemplate")
...
local buttonRemove = CreateFrame("Button", "MyAddonButtonRemove", adminFrame, "UIPanelButtonTemplate")
...
local buttonRecall = CreateFrame("Button", "MyAddonButtonRecall", adminFrame, "UIPanelButtonTemplate")
...
local buttonBotinfo = CreateFrame("Button", "MyAddonButtonBotInfo", adminFrame, "UIPanelButtonTemplate")
...
local buttonMove = CreateFrame("Button", "MyAddonButtonMove", adminFrame, "UIPanelButtonTemplate")
...
local buttonDelete = CreateFrame("Button", "MyAddonButtonDelete", adminFrame, "UIPanelButtonTemplate")
...
local redemptionButton = CreateFrame("Button", "MyAddonRedemptionButton", adminFrame, "SecureActionButtonTemplate")
...
local botLookupButton = CreateFrame("Button", "MyAddonBotLookupButton", adminFrame, "UIPanelButtonTemplate")
...
local lookupFrame = CreateFrame("Frame", "MyAddonLookupFrame", UIParent)
...
local lookupScrollFrame = CreateFrame("ScrollFrame", "MyAddonLookupScrollFrame", lookupFrame, "UIPanelScrollFrameTemplate")
...
local lookupList = CreateFrame("Frame", "MyAddonLookupList", lookupScrollFrame)
...
for key, value in pairs(classTable) do
  local button = CreateFrame("Button", "MyAddonLookupButton"..value, lookupList, "UIPanelButtonTemplate")
...
local hideLookupButton = CreateFrame("Button", "MyAddonHideLookupButton", lookupFrame, "UIPanelButtonTemplate")
...
local spawnFrame = CreateFrame("Frame", "MyAddonSpawnFrame", lookupFrame)
...
local buttonSpawnBot = CreateFrame("Button", "MyAddonButtonSpawnBot", spawnFrame, "UIPanelButtonTemplate")
...
local classInput = CreateFrame("EditBox", "MyAddonClassInput", spawnFrame, "InputBoxTemplate")
